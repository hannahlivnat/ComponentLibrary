...
class Nav extends Component {
  ...
  render = () => {
    ...
    return (
    <nav className="nav">
        <p className="nav-link" id="home" onClick={changedisplay}>
          <svg width="2em" height="2em" viewBox="0 0 16 16" className="bi bi-house-door" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <p className="nav-link" id="newform" onClick={changedisplay}>
        ...
        <p className="nav-link" id="profile" onClick={changedisplay}>
