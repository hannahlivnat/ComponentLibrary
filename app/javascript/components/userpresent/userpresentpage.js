...
class UserPresentPage extends Component {
  ...
  render = () => {
    const { components, newcomponent, newformmessage, currentuser, update, destroy } = this.props;
    return (
        <Router>
            ...
            <Switch>
                ...
                <UserProfile components={components} currentuser={currentuser} update={update} destroy={destroy}/>
                  </Route>
                </div>
            </Switch>
          </div>
